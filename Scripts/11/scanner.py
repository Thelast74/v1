...
print(f'''
    __  ___                   ____             __            {wh}
   /  |/  /___ _{gr}ZAE3M{red}____   / __ \____  _____/ /_____  _____{red}
  / /|_/ / __ `/ ___/ ___/  / / / / __ \/ ___/ //_/ _ \/ ___/{ble}
 / /  / / /_/ (__  |__  )  / /_/ / /_/ / /  / ,< /  __/ /    {yl}
/_/  /_/\__,_/____/____/  /_____/\____/_/  /_/|_|\___/_/ {gr}
                                               {wh}LaravelFucker {red}V1{res}
''')

dorklist = input(f"{gr}Give Me Your DorkList/{red}Zae3m> {gr}${res} ")
